...
# Programs that this script will launch.
# They will be launched in this order.
def programs_to_launch():
    return [
        ...
        Program(
            name            = 'term_bt',
            workspace       = "9",
            cmd             = 'alacritty --class term_bt --command bash -ic "wait bt"',
            matcher         = match_by_app_id('term_bt'),
            enabled         = False,
        ),
